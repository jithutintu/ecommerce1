...
<link rel="icon" type="image/x-icon" href="<c:url value="/images/favicon1.png"/>" />
</head>
	...
	<div class="row" style="margin-top:4px; margin-right:0px; margin-left:0px;margin-bottom:19px ">
		<div class="col-sm-4" style="margin-top:0px">
			<div class="container-fluid bg-1 text-center">
				<h3>Who Am I?</h3>
				<img src="<c:url value="/images/aboutImage.png"/>" class="img-circle" alt="AboutUs" width="350"
					height="350">
				<h3>ShopIeasy a WorldWide Speed Buy Site</h3>
			</div>
